...
void index_bounce_message(struct Mailbox *m, struct EmailArray *ea)
{
  ...
  rc = buf_get_field(buf_string(prompt), buf, MUTT_COMP_ALIAS, false, NULL, NULL, NULL, NULL);
...
void mutt_enter_command(void)
{
  ...
  if ((buf_get_field(":", buf, MUTT_COMP_COMMAND, false, NULL, NULL, NULL, NULL) != 0) ||
      buf_is_empty(buf))
  {
    goto done;
  }
...
bool mutt_edit_content_type(struct Email *e, struct Body *b, FILE *fp)
{
  ...
  if ((buf_get_field("Content-Type: ", buf, MUTT_COMP_NO_FLAGS, false, NULL, NULL, NULL, NULL) != 0) ||
      buf_is_empty(buf))
  {
    goto done;
  }
