...
int imap_mailbox_create(const char *path)
{
  ...
  if (buf_get_field(_("Create mailbox: "), name, MUTT_COMP_FILE, false, NULL, NULL, NULL, NULL) != 0)
  {
    goto done;
  }
...
int imap_mailbox_rename(const char *path)
{
  ...
  if (buf_get_field(buf_string(buf), newname, MUTT_COMP_FILE, false, NULL, NULL, NULL, NULL) != 0)
  {
    goto done;
  }
