...
/**
 * enum ImapCommandResponse - IMAP command responses
 *
 * Used in ImapCommand.state too
 */
enum ImapCommandResponse
{
  IMAP_RESP_NO       = -2,  ///< `<tag> NO ...`
  IMAP_RESP_BAD      = -1,  ///< `<tag> BAD ...`
  IMAP_RESP_OK       =  0,  ///< `<tag> OK ...`
  IMAP_RESP_CONTINUE =  1,  ///< `* ...`
  IMAP_RESP_RESPOND  =  2,  ///< `+`
  IMAP_RESP_NEW      =  3,  ///< ImapCommand.state additions
};
...
struct ImapCommand
{
  ...
  enum ImapCommandResponse state; ///< Command state, e.g. #IMAP_RESP_NEW
};
