...
syntax match neolog_date     "\v^\[\d\d\d\d-\d\d-\d\d \d\d:\d\d:\d\d\.\d\d\d\d\] *" conceal
...
syntax match neolog_function "\v%31v\i+\(\)"

syntax match neolog_perror_key  "\v%27v\<P\> " conceal transparent
syntax match neolog_error_key   "\v%27v\<E\> " conceal transparent
syntax match neolog_warning_key "\v%27v\<W\> " conceal transparent
syntax match neolog_message_key "\v%27v\<M\> " conceal transparent
syntax match neolog_debug1_key  "\v%27v\<1\> " conceal transparent
syntax match neolog_debug2_key  "\v%27v\<2\> " conceal transparent
syntax match neolog_debug3_key  "\v%27v\<3\> " conceal transparent
syntax match neolog_debug4_key  "\v%27v\<4\> " conceal transparent
syntax match neolog_debug5_key  "\v%27v\<5\> " conceal transparent
syntax match neolog_notify_key  "\v%27v\<N\> " conceal transparent

syntax match neolog_perror  "\v%27v\<P\> .*" contains=neolog_perror_key,neolog_function
syntax match neolog_error   "\v%27v\<E\> .*" contains=neolog_error_key,neolog_function
syntax match neolog_warning "\v%27v\<W\> .*" contains=neolog_warning_key,neolog_function
syntax match neolog_message "\v%27v\<M\> .*" contains=neolog_message_key,neolog_function
syntax match neolog_debug1  "\v%27v\<1\> .*" contains=neolog_debug1_key,neolog_function
syntax match neolog_debug2  "\v%27v\<2\> .*" contains=neolog_debug2_key,neolog_function
syntax match neolog_debug3  "\v%27v\<3\> .*" contains=neolog_debug3_key,neolog_function
syntax match neolog_debug4  "\v%27v\<4\> .*" contains=neolog_debug4_key,neolog_function
syntax match neolog_debug5  "\v%27v\<5\> .*" contains=neolog_debug5_key,neolog_function
syntax match neolog_notify  "\v%27v\<N\> .*" contains=neolog_notify_key,neolog_function
