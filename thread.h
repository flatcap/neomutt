...
#define mutt_next_thread(x)        _mutt_aside_thread(x, true, false)
#define mutt_previous_thread(x)    _mutt_aside_thread(x, false, false)
#define mutt_next_subthread(x)     _mutt_aside_thread(x, true, true)
#define mutt_previous_subthread(x) _mutt_aside_thread(x, false, true)
